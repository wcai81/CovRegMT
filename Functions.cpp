...
mat SSpvalues_Cpp(mat &YY, int k, int totsim){
    ...
    vec abscors(totcors), pvaluesSS(totcors, fill::zeros), pvaluesSD(totcors), mmaxs(totcors),  orderedpvalues(totcors);
    ...
    mat statsSS(totsim, totcors, fill::zeros), statsSD(totsim, totcors, fill::zeros);
